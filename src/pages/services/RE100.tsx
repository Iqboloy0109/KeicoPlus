      ...
      <section className="relative h-[35vh] sm:h-[40vh] min-h-[300px] sm:min-h-[350px] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-3xl mx-auto leading-relaxed">
            A global campaign for companies to source 100% of their electricity from renewable energy
          </p>
        </motion.div>
      </section>
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-dark mb-6">
              RE100 Campaign Support
            </h2>
            <p className="text-lg text-gray-700 mb-4">
              RE100 is a global campaign for companies to source 100% of their electricity from renewable energy.
            </p>
            <p className="text-lg text-gray-700 mb-8">
              We support companies in achieving RE100 through renewable energy introduction consulting and PPA contract support for solar, wind, and other renewable energy sources.
            </p>
            <p className="text-xl text-gray-600 leading-relaxed">
              Join leading companies in the transition to 100% renewable energy.
            </p>
          </motion.div>
        </div>
      </section>
